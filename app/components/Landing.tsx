...
export default function Landing() {
	return (
		<div className="text-xl sm:text-2xl lg:text-4xl min-h-[calc(100vh-84px)] lg:flex lg:flex-row lg:justify-between lg:justify-items-center flex-col lg:pt-40">
			<div className=" lg:pl-40 pt-20 md:text-left flex-col justify-end justify-items-center lg:justify-items-start flex-1">
				...
				<Image
					...
					height={450}
					priority
					className="image-1 w-2/4 lg:w-4/4 mb-14 lg:ml-20 lg:hidden"
				/>
				<a
